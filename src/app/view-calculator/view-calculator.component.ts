...
@Component({
  selector: 'app-view-calculator',
  templateUrl: './view-calculator.component.html',
  styleUrls: ['./view-calculator.component.css']
})
  ...
  pressNum(num: string) {
    ...
    if (num==".") {
      if (this.input !="" ) {
        ...
        const lastNum=this.num.getLastNumber()
